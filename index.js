 ...
 * @param {string} grade - Рівень оцінки для фільтрації.
 */
function filterStudentsByGrade(students, grade) {
  ...
  // Виведення інформації про студентів з необхідною оцінкою
  if (filteredStudents.length > 0) {
    // Виведення повідомлення для відстеження роботи програми
    console.log(`Студенти з оцінкою "${grade}":`);
    ...
    // Виведення повідомлення, якщо немає студентів з необхідною оцінкою
    console.log(`Немає студентів з оцінкою "${grade}"`);
  }
}
 ...
 *  @param {Array} arr - Масив для обробки.
 */
 ...
 *  @param {number} maxLength - Максимальна довжина масиву.
 */
 ...
 *
 *  @param {Array} arr1  - Перший масив чисел.
 *  @param {Array} arr2  - Другий масив чисел.
 */
function compareArrays(arr1, arr2) {
  // Перевіряємо, чи обидва аргументи є масивами.
  if (!Array.isArray(arr1) || !Array.isArray(arr2)) {
    console.error("Обидва аргументи мають бути масивами!");
    return;
  }
  ...
  console.assert(sortedArr1 === sortedArr2, "Assertion failed: Масиви не однакові!");
}
 ...
 *
 *  @param {number} size - розмір матриці.
 *  @returns {Array} Повернеться згенерована матриця.
 */
 ...
 *  @param {object} userInput - Об'єкт з введеними користувачем даними (username та password).
 ...
 *
 * @param {Array} products - Масив об'єктів товарів з властивостями `price` та `title`.
 */
...
function countVowelsAndConsonants(word) {
  ...
  const vowels = "aeiouAEIOU";
   // Лічильник голосних та приголосних літер.
   let vowelsCount = 0;
